...
import { getSongs, createSong, updateSong, deleteSong, getArtists, getVibes } from '../../services/api';
...
export default function SongsPage() {
      ...
      accessor: (song: Song) =>
        editingSong?.id === song.id ? (
          <div className="flex gap-2">
            ...
            <Button variant="secondary" onClick={() => setEditingSong(null)}>Cancel</Button>
          </div>
        ) : (
          <div className="flex gap-2">
            <Button
  ...
  return (
    <AdminLayout 
      title="Songs" 
      subtitle="Manage all songs in your database"
    >
      ...
      {isCreating && (
        <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md border border-gray-200 dark:border-gray-700 mb-8">
          <div className="flex justify-between items-center mb-4">
            <h3 className="text-xl font-bold text-gray-800 dark:text-white">Add New Song</h3>
          ...
          <form onSubmit={handleCreateSong} className="space-y-4">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Vibes</label>
      ...
      {loading ? (
        ...
        <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-8 text-center">
          <p className="text-yellow-800 dark:text-yellow-200 text-lg">No songs found. Add a song to get started.</p>
        </div>
      ) : (
        <DataTable
          data={songs}
